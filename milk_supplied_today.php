...
<div class="h4 container breadcrumb" style="color:dodgerblue;padding-top: 1.5em;">Milk Supplied</div>
...
<div class="container-fluid">
    ...
    <div class="col-lg-8" >
        <div class="col-md-12" style="box-shadow: 2px 2px 2px 2px lightgray;">
            <div id="farmers_regions"  style='height:300px; padding-top: 10px;'>
...
//                $("#dairyTable").DataTable();
                ...
                var transactionsTable =  $("#dairyTable").DataTable({
                    responsive: true,
                    columns: [
                        { data: 'name', name: 'farmer' },
                        { data: 'contact', name: 'contact' },
                        { data: 'dateFrom', name: 'date' },
                        { data: 'milk_quantity', name: 'milk_quantity' }
                    ]
                });

                //apply search

                $(".transactions-search-input").on('keyup click change', function(){
                    //get column index
                    var index = $(this).attr("id");
                    //get search input value
                    var inputValue = $(this).val();
                    transactionsTable.columns(index).search(inputValue).draw();
                });
//                console.log(data);
            }
