...
<div class="col-md-12 col-sm-4 col-xs-12" style="border: thin solid black; padding: 10px 15px 25px 15px; border-radius: 5px;">
<div class="row">
  <div class="col-sm-2">
...
<div class="col-sm-2">
    ...
    <div>
    <select id="sel_production_data" onchange="loadProductionOptions();"  class="select2_single form-control">
    <option  value="all">all</option>
