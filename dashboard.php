...
<div class="container-fluid">
 <?php echo "<div class='col-xs-12'> <h2 style=\"font-size:16pt; padding:10px 0px; border-bottom:1px solid #eee;\"><i class='fa fa-file'></i> $dataset_name</h2>
  <div class=\"clearfix\"></div></div>";?>
  <div class="col-md-8" style="border-radius: 5px; border: darkgrey thin solid; background-color: white;">
    <div class="row">
	<div class="col-md-4 col-sm-4 col-xs-12" >
            <div class="x_panel tile  overflow_hidden">
             <h4>Total Seed Given Out</h4>
                <div class="data">
