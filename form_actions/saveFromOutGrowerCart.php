...
//            $reciept_id = $reciept_rows[0]['id'];
        ...
        if ($date != "") {
            ...
            $flag = $mCrudFunctions->insert_into_out_grower_input_tb($va_dataset_id,$dataset_id, $va_code, $meta_id, $item_id, $unit_price, $qty, $date, $reciept_url);
            //echo $flag;
...
//            $reciept_id = $reciept_rows[0]['id'];
        ...
        $flag = $mCrudFunctions->insert_into_out_grower_produce_tb($va_dataset_id,$dataset_id, $va_code, $meta_id, $qty, $commission_per_unit, $reciept_url, $payment_status, $unit_price, $date);
//            echo $flag;
        if ($flag == 1) {
