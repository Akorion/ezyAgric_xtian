...
$dataset_name = strlen($dataset_name) > 40? substr($dataset_name, 0, 39)."...": $dataset_name;// = substr($dataset_name,0,38).'</br>'.substr($dataset_name,38);
 ...
 <div class=\"col-md-3 col-sm-4 col-xs-12 text-center\" >
    <div class=\"x_panel tile fixed_height_500 container\">
    <div class='col-xs-12'>
      <div class=\"panel-title\">
      <h2><i class='fa fa-file'></i> <br/> <br/>  $dataset_name</h2>
    ...
    <h6 style='font-size:12px !important;'>$period</h6>
        <h6><a href=\"dashboard.php?token=$key\" class=\"btn btn-success btn-sm\">Open</a></h6>
        </div>
    </div>
