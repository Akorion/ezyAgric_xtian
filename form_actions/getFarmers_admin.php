...
//echo"<p>Gardens: $total_gardens ,AverageAcerage: $average </p><br/>";
 ...
 <p style=\"color:#888\"> <b>Av.Acerage:</b> $average</p><br/>";
  ...
  <p style=\"margin-top:10px\"><a class=\"btn soil-Test\" data-toggle='modal' data-target='#AddSoilTesting' data-id='$farmer_id' style=\"background: #03a9f4; color:#FFFFFF; margin:0; width:100%;\">Attach Soil Testing Results &raquo;</a></p>
      </div>
    </div>
  </div>";
            }
...
<!--adding/attaching soil testing results-->
<div id="AddSoilTesting" class="modal fade">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="../admin/import_soilTesting_csv.php?token=<?php echo $token; ?>&type=<?php echo $type; ?>&dataset_id=<?php echo $id ;?>" method="post" enctype="multipart/form-data" >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Attach Soil Testing Results</h4>
                </div>
                <div class="modal-body">
                    <input id="dataset"   type="hidden" name="id" />
                    <p><input id="file" type="file" name="csv" value="Choose CSV"></p>
                </div>
...
<script type="text/javascript">
    ...
    $(document).on('click','.soil-Test',function () {
